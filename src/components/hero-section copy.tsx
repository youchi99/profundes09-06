      ...
      <div className="max-w-[1300px] mx-auto px-7.5 2xl:px-0">
        <div className="w-full flex flex-col lg:flex-row gap-5">
          <div className="w-full lg:w-[58%] xl:w-[60%] flex flex-col gap-5 lg:overflow-visible">
            <div className="mt-5 lg:mt-0 flex flex-col gap-5">
              ...
              <div className="flex flex-col items-center justify-center lg:items-start lg:justify-start gap-5">
                ...
                >
                  {/* -mt-[5px] -mb-[22px] lg:-mt-6 lg:-mb-8.5 lg:-mr-44.25 xl:-mt-2 xl:-mb-11.75 xl:-mr-46.25 */}
              ...
              {/* CTA */}
              <div className="mt-5 lg:mt-12 xl:mt-14 flex flex-col lg:flex-row gap-5 flex-nowrap items-center lg:justify-between">
                <div className="w-full lg:w-[42%] xl:w-[81%]">
                  <FadeIn
                    animation={{
                ...
                <div className="w-full lg:w-[94%] xl:w-[81%] z-10 flex flex-col lg:flex-row items-center gap-5 lg:justify-end mt-2.25 lg:-mr-[264px] xl:mt-0 xl:-mr-[61px]">
                  <FadeIn
                    className="w-[66%] lg:w-[75%]"
                    animation={{
            ...
            <div className="relative z-10 flex flex-nowrap justify-center lg:justify-center lg:mt-14 2xl:mt-14.5 mr-0 lg:mr-3 xl:mr-10 order-first lg:order-last">
              <FadeIn
                ...
                className="grid grid-cols-3 gap-5 w-full lg:w-5/6 xl:w-3/4"
              >
          ...
          <div className="relative w-full lg:w-[67%] order-first lg:order-last">
            <div className="relative -z-10">
              {/* lg:mt-30 lg:ml-3.5 */}
              <div className="w-full lg:-ml-9 lg:mt-28 xl:-ml-32 xl:mt-35 2xl:-ml-26 2xl:mt-32">
                <FadeIn
            ...
            <FadeIn
              ...
              className="absolute top-[300px] 2xl:top-[370px] right-0 hidden xl:block"
            >
